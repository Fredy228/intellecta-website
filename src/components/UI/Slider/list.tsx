//Student img
import homeFirstImg from 'assets/img/homeSlide.png'
import homeSecondImg from 'assets/img/homeSLide1.png'
import homeThirdImg from 'assets/img/homeSlide2.png'
...
export const slideStudents: TSlideProps[] = [
    {
        id: 1,
        image: studentSlide,
    },
...
export const slideTeacher: TSlideProps[] = [
    {
        id: 1,
        image: teacherSlide,
    },
...
export const slideAdmins: TSlideProps[] = [
    {
        id: 1,
        image: adminSlide,
    },
